...
//int tmp=getRandomInteger(10,1);
		int tmp=1;
		if(tmp==1 || tmp ==6) {
			NinePatch patch = new NinePatch(atlas.findRegion("map_bg"), 2, 2, 2, 2);
		...
		//world 1
		LevelButton level1 = new LevelButton(1, "SCENE 1");
		addChild(level1);
centerActorX(level1);
		...
		//world 1
		LevelButton level2 = new LevelButton(2, "SCENE 2");
		addChild(level2);
		centerActorX(level2);
		...
		//world 1
		LevelButton level3 = new LevelButton(3, "SCENE 3");
		addChild(level3);
		centerActorX(level3);
...
//		totalScore += SuperMario.data.getScore(5);
		...
		//world 6
		LevelButton level6 = new LevelButton(77, "NEXT SCENARIO");
