...
public class LevelMap2 extends StageGame {
...
//int tmp=getRandomInteger(10,1);
		...
		//world 1
		LevelButton level1 = new LevelButton(4, "SCENE 1");
		addChild(level1);
		centerActorX(level1);
		...
		//world 1
		LevelButton level2 = new LevelButton(5, "SCENE 2");
		addChild(level2);
		centerActorX(level2);
		...
		//world 1
		LevelButton level3 = new LevelButton(6, "SCENE 3");
		addChild(level3);
		centerActorX(level3);
...
//		totalScore += SuperMario.data.getScore(5);
		...
		//world 6
		LevelButton level6 = new LevelButton(777, "NEXT SCENARIO");
