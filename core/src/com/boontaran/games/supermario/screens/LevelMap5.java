...
public class LevelMap5 extends StageGame {
...
//int tmp=getRandomInteger(10,1);
		...
		//world 1
		LevelButton level1 = new LevelButton(13, "SCENE 1");
		addChild(level1);
		centerActorX(level1);
		...
		//world 1
		LevelButton level2 = new LevelButton(14, "SCENE 2");
		addChild(level2);
		centerActorX(level2);
		level2.setX(level2.getWidth()+50);
		level2.setY(getHeight() - level2.getHeight() - 450);
		level2.addListener(levelButtonListener);
		totalScore += SuperMario.data.getScore(1);

		//world 1
		LevelButton level3 = new LevelButton(15, "SCENE 3");
		addChild(level3);
		centerActorX(level3);
		level3.setX(level3.getWidth()+230);
		level3.setY(getHeight() - level3.getHeight() - 450);
...
//		totalScore += SuperMario.data.getScore(5);
		...
		//world 6
		LevelButton level6 = new LevelButton(777777, "NEXT SCENARIO");
		addOverlayChild(level6);
		centerActorX(level6);
		//centerActorX(level6);
		level6.setX(level6.getWidth()+290);
		level6.setY(getHeight() - level1.getHeight() - 450);
		level6.addListener(levelButtonListener2);


		//world 6
		LevelButton level7 = new LevelButton(777777, "    BACK     ");
