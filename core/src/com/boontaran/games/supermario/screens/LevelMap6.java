...
public class LevelMap6 extends StageGame {
...
//int tmp=getRandomInteger(10,1);
		int tmp=5;
		if(tmp==1 || tmp ==6) {
			NinePatch patch = new NinePatch(atlas.findRegion("intro_bg"), 2, 2, 2, 2);
		...
		//world 1
		LevelButton level1 = new LevelButton(16, "       ESCAPE FROM ARABIA    ");
		addChild(level1);
//centerActorX(level1);
...
//		//world 2
//		LevelButton level2 = new LevelButton(2, "        QATOR         ");
//		addChild(level2);
//		centerActorX(level2);
//		level2.setY(level1.getY() - level2.getHeight() - 10);
...
//
//		//world 3
//		LevelButton level3 = new LevelButton(3, "       KUWAIT        ");
//		addChild(level3);
//		centerActorX(level3);
//		level3.setY(level2.getY() - level3.getHeight() - 10);
...
//
//		//world 4
//		LevelButton level4 = new LevelButton(4, "       OMAN       ");
//		addChild(level4);
//		centerActorX(level4);
//		level4.setY(level3.getY() - level4.getHeight() - 10);
...
//
//		//world 5
//		LevelButton level5 = new LevelButton(5, "    BAHRAIN      ");
//		addChild(level5);
//		centerActorX(level5);
//		level5.setY(level4.getY() - level5.getHeight() - 10);
...
//		totalScore += SuperMario.data.getScore(5);
		...
		//world 6
		LevelButton level6 = new LevelButton(7777777, "    HOME    ");
		addOverlayChild(level6);
		centerActorX(level6);
		centerActorX(level6);
         level6.setX(level6.getWidth()-190);
